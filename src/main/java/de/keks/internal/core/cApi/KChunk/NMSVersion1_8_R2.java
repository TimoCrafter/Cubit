...
public class NMSVersion1_8_R2 {
	...
	public NMSVersion1_8_R2(final World world, final int x, final int z) {
	...
	public NMSVersion1_8_R2(final org.bukkit.Chunk chunk) {
	...
	public static final void refreshChunk(final World world, final int x, final int z, final Player... players) {
		final NMSVersion1_8_R2 packet = new NMSVersion1_8_R2(world.getChunkAt(x, z));
