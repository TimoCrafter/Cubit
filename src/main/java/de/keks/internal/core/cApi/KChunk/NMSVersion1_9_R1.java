...
public class NMSVersion1_9_R1 {
	...
	public NMSVersion1_9_R1(final World world, final int x, final int z) {
	...
	public NMSVersion1_9_R1(final org.bukkit.Chunk chunk) {
	...
	public static final void refreshChunk(final World world, final int x, final int z, final Player... players) {
		final NMSVersion1_9_R1 packet = new NMSVersion1_9_R1(world.getChunkAt(x, z));
