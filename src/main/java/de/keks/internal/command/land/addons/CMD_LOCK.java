...
public class CMD_LOCK extends CubitCore {
    ...
    public boolean execute(final CommandSender sender, final String[] args) {
        if (sender.hasPermission("cubit.flag.lock")) {
            ...
            this.setupLand.executorServiceCommands.submit(new Runnable() {
                public void run() {
                    ...
                    if (args.length < 2) {
                        ...
                        CMD_LOCK.this.setupLand.executorServiceRegions.submit(new RegionSaveTask(CMD_LOCK.this.getWorldGuard(), null, world));
